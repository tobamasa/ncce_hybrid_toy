...
def make_sklearn_datasets(n_samples, data= None, noise=1.0, save_dir=None, center=None):
...
if __name__ == '__main__':
    for i in range(2):
        ...
        make_sklearn_datasets(1000, data="moons", noise=.05, save_dir='./moon/noise05_seed' + str(i))
        make_sklearn_datasets(1000, data="moons", noise=.10, save_dir='./moon/noise10_seed' + str(i))
        make_sklearn_datasets(1000, data="circles", noise=.05, save_dir='./circles/noise05_seed' + str(i))
        make_sklearn_datasets(1000, data="circles", noise=.10, save_dir='./circles/noise10_seed' + str(i))
        make_sklearn_datasets(1000, data="roll", noise=.5, save_dir='./roll/noise05_seed' + str(i))
        make_sklearn_datasets(1000, data="roll", noise=1.0, save_dir='./roll/noise10_seed' + str(i))
        make_sklearn_datasets(1000, data="blobs", save_dir='./blobs/std03_seed' + str(i), center=5)