...
__all__ = ['OoD_JEMRunner_NOISE_UNCOND']
...
def anneal_jem_dsm(scorenet, samples, sigmas, classes=None, anneal_power=2.0):
    ...
    logits = scorenet(perturbed_samples, None, None)
...
def anneal_ce_loss(model, samples, sigmas, classes):
    ...
    logits = model(perturbed_samples, None, None)
...
class OoD_JEMRunner_NOISE_UNCOND():
